...
async def people_websocket_handler(executor, storage_executor, ws: WebSocket, client_id: str, sessions: dict, run_detection_fn, stream_type: str):
    await ws.accept()
        ...
        while True:
            ...
            if action == "start_stream":
                try:
                    ...
                    client_args = (client_id, kvs_url, camera_id, user_id, org_id,threshold,alert_rate, sessions, loop, storage_executor)
