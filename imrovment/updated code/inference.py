    ...
    **NEW in v2.0:**
    ...
    with _lock:
        ...
        try:
            ...
            # **NEW in v2.0: OPTIMIZED configuration**
            logger.info("Configuring OPTIMIZED People Counting System (v2.0)")
            config = {
                ...
                'temporal_window': 900,  # 15 minutes
                'spatial_threshold': 200,  # pixels

                # Tracking parameters
                'max_disappeared': 30,  # frames
                'min_hits_confirm': 3,  # consecutive hits
                'max_distance': 200.0,  # pixels

                # **NEW: Two-stage matching parameters**
                'iou_gate': 0.3,  # IoU threshold for stage 1
                'spatial_gate': 0.5,  # Spatial threshold for stage 2 (normalized)
                'appearance_gate': 0.3,  # Appearance threshold for stage 2

                # **NEW: Feature EMA smoothing**
                'feature_ema_alpha': 0.9,  # 90% old + 10% new
